...
/**
 * @file
 * Contains \Drupal\pulso_battool\Form\TermDeleteForm.
 */
 ...
 */
class BatToolResultDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('entity.bat_tool_result.collection');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('pulso_battool')->notice('deleted %title.',
      [
